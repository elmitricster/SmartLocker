...
public class QuestionandAnswer extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.answer_questionand);
        ...
        buttonInsert.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                task.execute("http://118.221.14.79/qnaquery.php", name,country);
    ...
    class InsertData extends AsyncTask<String, Void, String>{
        ...
        protected void onPreExecute() {
            ...
            progressDialog = ProgressDialog.show(QuestionandAnswer.this,
        ...
        protected String doInBackground(String... params) {
            ...
            String que = (String)params[2];

            String serverURL = (String)params[0];
            String postParameters = "email=" + email + "&que=" + que;
